...
export default function DashboardLayout({
  ...
  return (
    <div className="flex min-h-dvh bg-muted/30">
      ...
      {/* Sidebar */}
      <aside
        className={`fixed inset-y-0 left-0 z-50 flex w-64 flex-col border-r bg-card transition-transform duration-200 lg:sticky lg:top-0 lg:h-dvh lg:translate-x-0 lg:overflow-y-auto ${
